                  ...
                  ? Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => HomePage(
                            datetimePage: DateFormat('yyyy-MM-dd').format(day),
                            title: 'Activity - ' + DateFormat('yyyy-MM-dd').format(day),
                            isHome: false),
                      ))
                  : _scaffoldKey.currentState
                      .showSnackBar(new SnackBar(content: new Text("Cannot select a date in the future"))),
              child: new IgnorePointer(
                  child: new GaugeChart(_createSampleData(dayVar), dayVar.steps, dayVar.goal.target, day.day,
                      animate: true)));
        },
      ),
      drawer: GlobDrawer(),
